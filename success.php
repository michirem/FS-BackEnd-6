			...
			<div class="content">
			  <div class="section group">
			    <div class="payment">
			    	...
			    	<p>Thanks for Purchase. Receive your order successfully. We will contact you with payment slip and also delivery details. Here is your order details... <a class="btn btn-success m-2" href="order_details.php?userId=<?=$customerId?>">Visit Here</a></p>
			    </div>
		 		</div>
		 	</div>
		</div>
