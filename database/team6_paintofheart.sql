...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2021 at 04:21 AM
...
(6, 5, '120.50', '2021-05-26 11:23:46'),
(7, 5, '143.00', '2021-05-26 11:37:01');
...
(3, 'Light Pink', 4, '36.00', 'Give concrete a soft shell', '../pictures/heart3lightpink.png', 0, 0),
...
(11, 'Red', 3, '35.00', 'Go red or go home', '../pictures/heart11red.png', 0, 0),
...
(15, 'Green', 7, '40.50', 'Like nature intended it', '../pictures/heart14green.png', 0, 0),
...
INSERT INTO `question` (`id`, `fk_user_id`, `fk_item_id`, `question`, `answer`, `date`) VALUES
(1, 3, 5, 'Is there lead in this paint?', 'Not at all, lead is illegal!', '2020-04-14 12:45:00'),
(2, 4, 5, 'Is this good for bathroom walls?', 'Please see our other products which match your bathroom wall material.', '2020-05-14 13:56:00'),
(3, 5, 3, 'Is this paint supposed to be more like a glue? The product I recieved is very thick and sticky and hard to roll on.', '', '2020-06-14 21:57:00'),
(4, 6, 2, 'Do you apply it with a roller or brush?', 'Both tools can be used!', '2020-07-14 15:05:00'),
(5, 7, 8, 'Can this be applied over a piece that was painted with an oil based paint?', '', '2020-08-14 10:06:00'),
(6, 3, 8, 'Do you have lighter color than this?', '', '2020-09-14 09:20:00'),
(7, 5, 1, 'Can glitter paint additive be mixed in with this paint?', 'If you san stand watching glitter then of course.', '2020-10-14 20:47:00');
...
(3, 4, 12, 'Goldenrod', 3, '126.00', '../pictures/heart12gold.png', '2020-05-14 13:56:00', 2, 2),
...
(39, 5, 16, 'Light Blue', 1, '38.00', '../pictures/heart15lightblue.png', '2021-05-26 11:23:46', 0, 10),
(40, 5, 15, 'Green', 1, '40.50', '../pictures/heart14green.png', '2021-05-26 11:23:46', 0, 10),
(41, 5, 12, 'Goldenrod', 1, '42.00', '../pictures/heart12gold.png', '2021-05-26 11:23:46', 0, 10),
(42, 5, 16, 'Light Blue', 2, '76.00', '../pictures/heart15lightblue.png', '2021-05-26 11:37:01', 0, 11),
(43, 5, 7, 'Coral', 2, '67.00', '../pictures/heart7coral.png', '2021-05-26 11:37:01', 0, 11);
...
--
ALTER TABLE `tbl_cart`
  MODIFY `cartId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
