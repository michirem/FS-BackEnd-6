<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="home.php"><img class="rounded-circle" src="pictures/logo.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            if (isset($_SESSION['adm'])) {
                ...
                echo '<ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="btn home-btn pb-1 mb-3 ms-3 text-light" aria-current="page" href="actions/logout.php?logout">Logout ' . $adName . '</a>
            </li>
            </ul>
            <form class="d-flex" method ="GET" action="search.php">
                ...
                echo '<ul class="navbar-nav me-auto mb-2 mb-lg-0 p-2 text-center mt-2">
                <li class="nav-item">
                <p class="fs-5 pt-1"><span class="text-info">Hi ' . $name . '</span></p>
                </li>
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="home.php">Home</a>
                </li>
                ...
                if ($chkWlist) {
                    ...
                    <a class="btn dash-btn mb-3 p-2 m-1 active text-dark" aria-current="page" href="wish_list.php?userId=' . $id . '">Wishlist</a>
                </li>';
                }
                if ($chkCart) {
                    echo '<li class="nav-item">
                    <a class="btn nav-btn mb-3 p-2 m-1 active text-dark" aria-current="page" href="payment.php?userId=' . $id . '">Payment</a>
                </li>';
                }
                if ($chkOrder) {
                    echo '<li class="nav-item">
                    <a class="btn btn-info mb-3 p-2 m-1 active text-dark" aria-current="page" href="order_details.php?userId=' . $id . '">Order</a>
                </li>';
                }
                echo '</ul>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 p-2 text-center">
            <li class="nav-item">
                <a class="btn home-btn pb-1 mb-3 ms-3 text-light" href="?customerId=' . $id . '">Logout </a>
            </li>
            </ul>';
            } else { // general navbar
            ...
            <span class="nav-item">
            <a class="btn home-btn btn-small pb-1 mb-3 ms-3 text-light" href="login.php">Login</a>
        </span>';
            }
            ?>
        </div>
