...
<div class="grid_10">
	...
	<a href="product_add.php" class='btn btn-success my-3 save-btn'>Add Product</a>
	</td>
		...
		?>
				<tr class="odd gradeX">
					...
					<?php 
						...
						<td><?php 
						if ($product['visibility']==1) { // visible
							echo "<h1 class='status text-success display-5'>&bull;</h1>";
						} else { // hidden
							echo "<h2 class='status text-danger'>-</h2>";
						}
